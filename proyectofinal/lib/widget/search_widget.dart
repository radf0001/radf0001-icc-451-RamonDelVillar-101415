                ...
                Expanded(
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String imageUrl = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${resultList[index].split(' ')[0]}.png";
                          return InkWell(
                              ...
                              if(MediaQuery.of(context).viewInsets.bottom > 0) {
                                ...
                                if (isNameFilterSelected) {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => PokemonDetailScreen(pokemon: PokemonBasicData(id: resultList[index].split(' ')[0], name: resultList[index].split(' ')[1], imageUrl: imageUrl)),
                                      ));
                                } else {
                                  Navigator.push(
                                      context,
