                ...
                onTap: () {
                  if(MediaQuery.of(context).viewInsets.bottom > 0) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PokemonDetailScreen(pokemon: PokemonBasicData(id: evolutions[index].id!, name: evolutions[index].name!, cardColor: index.isEven ?Colors.blueAccent : Colors.redAccent)),
                        ));
                  }
                },
              );
